...
***********************************************************************
# 项目结构说明
本项目包括两个模块：`ckooc-ml`和`ckooc-nlp`，ckooc-ml主要是机器学习算法实现代码，ckooc-nlp主要是自然语言处理相关代码

---
#ckooc-ml
本模块主要是对一些常用的算法的实现，以及基于spark的机器学习算法实现。<br>
...
## 数据预处理
[数据预处理]()主要对算法需要用到的数据进行前期的清洗等操作，其中分词等使用到了[HanLP](https://github.com/hankcs/HanLP)相关的代码。
